...
;(api as ElectronAPI).showNativeContextMenu = (items) => ipcRenderer.invoke('app:show-native-context-menu', items)
...
;(api as ElectronAPI).startCowartCanvas = (request) => ipcRenderer.invoke('__cowart:start-canvas', request)
