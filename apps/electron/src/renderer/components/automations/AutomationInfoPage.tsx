    ...
    <Info_Page className={className}>
      ...
      <Info_Page.Content>
        ...
        <Info_Section title={t('automations.sectionRawConfig')}>
          <div className="rounded-surface shadow-minimal overflow-hidden [&_pre]:!bg-transparent [&_.relative]:!bg-transparent [&_.relative]:!border-0 [&_.relative>div:first-child]:!bg-transparent [&_.relative>div:first-child]:!border-0">
