  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col bg-foreground-2">
      {SHOW_LEGACY_EMBEDDED_TOOLBAR && toolbarPinned && (
        <div
          className="mx-2 mt-2 shrink-0 rounded-touch border border-border bg-background/95 p-1 shadow-minimal"
          ...
          trailingContent={(
            <div className="flex shrink-0 items-center gap-1">
              ...
              {pinnedExtensions.map((extension) => (
                ...
                >
                  {extension.icon ? (
                    <img src={extension.icon} alt="" className="h-4 w-4 rounded-menu-item object-contain" />
                  ) : (
              ...
              <Button
                ...
                className={cn(
                  'size-control-compact rounded-control text-muted-foreground hover:text-foreground',
              ...
              <Button
                ...
                className="size-control-compact rounded-control bg-foreground/[0.08] text-foreground hover:bg-foreground/[0.12]"
      ...
      <div className="relative min-h-0 flex-1 bg-foreground-2">
        <div ref={surfaceRef} className="h-full min-h-0 w-full rounded-touch bg-background" />
        {activeId && isCrashed && (
          <main className="absolute inset-0 z-local flex items-center justify-center rounded-touch bg-background px-8">
