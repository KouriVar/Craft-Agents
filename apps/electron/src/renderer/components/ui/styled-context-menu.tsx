...
>(({ className, variant = "default", ...props }, ref) => (
  <ContextMenuItem
    ref={ref}
    className={cn(
      "gap-3 pr-4 rounded-menu-item hover:bg-foreground/[0.03] focus:bg-foreground/[0.03]",
...
>(({ className, ...props }, ref) => (
  <ContextMenuSubTrigger
    ref={ref}
    className={cn(
      "gap-3 pr-4 rounded-menu-item hover:bg-foreground/10 focus:bg-foreground/10 data-[state=open]:bg-foreground/10",
