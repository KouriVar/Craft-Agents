...
export const CHANNEL_MAP = {
  ...
  getPrivacyPolicy: invoke(RPC_CHANNELS.privacy.GET_POLICY),
  setPrivacyPolicy: invoke(RPC_CHANNELS.privacy.SET_POLICY),
  getPrivacyMode: invoke(RPC_CHANNELS.privacy.GET_PRIVACY_MODE),
  setPrivacyMode: invoke(RPC_CHANNELS.privacy.SET_PRIVACY_MODE),
  ...
  createLibraryDocument: invoke(RPC_CHANNELS.library.CREATE),
  createLibraryDocumentFromSession: invoke(RPC_CHANNELS.library.CREATE_FROM_SESSION),
  updateLibraryDocument: invoke(RPC_CHANNELS.library.UPDATE),
  archiveLibraryDocument: invoke(RPC_CHANNELS.library.ARCHIVE),
  unarchiveLibraryDocument: invoke(RPC_CHANNELS.library.UNARCHIVE),
  deleteLibraryDocument: invoke(RPC_CHANNELS.library.DELETE),
  listLibraryVersions: invoke(RPC_CHANNELS.library.LIST_VERSIONS),
  getLibraryVersion: invoke(RPC_CHANNELS.library.GET_VERSION),
  restoreLibraryVersion: invoke(RPC_CHANNELS.library.RESTORE_VERSION),
