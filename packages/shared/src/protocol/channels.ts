...
export const RPC_CHANNELS = {
  ...
  window: {
    ...
    MAXIMIZED_STATE: 'window:maximizedState',
    GET_MAXIMIZED_STATE: 'window:getMaximizedState',
  },
  screenCapture: {
    CURRENT: 'screen-capture:current',
    RESULT: 'screen-capture:result',
    REQUESTED: 'screen-capture:requested',
    SHORTCUT_STATUS: 'screen-capture:shortcut-status',
    GET_SHORTCUT_ENABLED: 'screen-capture:get-shortcut-enabled',
    SET_SHORTCUT_ENABLED: 'screen-capture:set-shortcut-enabled',
    GET_HIDE_APP: 'screen-capture:get-hide-app',
    SET_HIDE_APP: 'screen-capture:set-hide-app',
    GET_SHORTCUT_STATUS: 'screen-capture:get-shortcut-status',
    GET_PERMISSION_STATUS: 'screen-capture:get-permission-status',
    OPEN_PERMISSION_SETTINGS: 'screen-capture:open-permission-settings',
  },
  file: {
    READ: 'file:read',
    READ_WIDGET: 'file:readWidget',
  ...
  widgets: {
    READ_MCP_RESOURCE: 'widgets:readMcpResource',
    CALL_MCP_TOOL: 'widgets:callMcpTool',
  },
  fs: {
    SEARCH: 'fs:search',
  ...
  settings: {
    ...
    GET_DEFAULT_AGENT_RUNTIME: 'settings:getDefaultAgentRuntime',
    SET_DEFAULT_AGENT_RUNTIME: 'settings:setDefaultAgentRuntime',
    GET_MULTIMODAL_MODEL: 'settings:getMultimodalModel',
    SET_MULTIMODAL_MODEL: 'settings:setMultimodalModel',
  ...
  experts: {
    ...
    DUPLICATE: 'experts:duplicate',
    DELETE: 'experts:delete',
    GET_CAPABILITY_ASSIGNMENT: 'experts:getCapabilityAssignment',
    SET_CAPABILITY_ASSIGNMENT: 'experts:setCapabilityAssignment',
    RESOLVE_CAPABILITIES: 'experts:resolveCapabilities',
  },
  connectors: {
  ...
  oauth: {
    ...
    CANCEL: 'oauth:cancel',
    REVOKE: 'oauth:revoke',
    APP_GET: 'oauthApp:get',
    APP_SET: 'oauthApp:set',
    APP_DELETE: 'oauthApp:delete',
  },
  workspace: {
  ...
  plugins: {
    LIST: 'plugins:list',
    GET_POLICIES: 'plugins:getPolicies',
    SET_POLICY: 'plugins:setPolicy',
    GET_MCP_STATUS: 'plugins:getMcpStatus',
    GET_AUTH_STATUS: 'plugins:getAuthStatus',
    DIAGNOSE_MCP: 'plugins:diagnoseMcp',
    INSTALL_GIT: 'plugins:installGit',
    LIST_MARKETPLACE_SOURCES: 'plugins:listMarketplaceSources',
    ADD_MARKETPLACE_SOURCE: 'plugins:addMarketplaceSource',
    REMOVE_MARKETPLACE_SOURCE: 'plugins:removeMarketplaceSource',
    GET_MARKETPLACE_CATALOG: 'plugins:getMarketplaceCatalog',
    PREVIEW_UPDATE: 'plugins:previewUpdate',
    INSTALL_MARKETPLACE_PLUGIN: 'plugins:installMarketplacePlugin',
    CONNECT_NATIVE_SOURCE: 'plugins:connectNativeSource',
    REGISTER_LOCAL: 'plugins:registerLocal',
    SET_ENABLED: 'plugins:setEnabled',
    UNREGISTER: 'plugins:unregister',
    REMOVE_MANAGED: 'plugins:removeManaged',
  ...
  input: {
    ...
    GET_FILE_REVIEW_OPEN_MODE: 'input:getFileReviewOpenMode',
    SET_FILE_REVIEW_OPEN_MODE: 'input:setFileReviewOpenMode',
  },
  power: {
  ...
  cognition: {
    GET_STATUS: 'cognition:getStatus',
    LIST_EVENTS: 'cognition:listEvents',
    LIST_OBSERVATIONS: 'cognition:listObservations',
    LIST_LOOPS: 'cognition:listLoops',
    RESOLVE_LOOP: 'cognition:resolveLoop',
    DISMISS_LOOP: 'cognition:dismissLoop',
    LIST_REFLECTIONS: 'cognition:listReflections',
    LIST_GUIDANCE: 'cognition:listGuidance',
    DISMISS_GUIDANCE: 'cognition:dismissGuidance',
    REFRESH_GUIDANCE: 'cognition:refreshGuidance',
  ...
  browserPane: {
    ...
    ADD_BOOKMARK: 'browser-pane:add-bookmark',
    UPDATE_BOOKMARK: 'browser-pane:update-bookmark',
    REMOVE_BOOKMARK: 'browser-pane:remove-bookmark',
    LIST_BOOKMARK_FOLDERS: 'browser-pane:list-bookmark-folders',
    CREATE_BOOKMARK_FOLDER: 'browser-pane:create-bookmark-folder',
    RENAME_BOOKMARK_FOLDER: 'browser-pane:rename-bookmark-folder',
    REMOVE_BOOKMARK_FOLDER: 'browser-pane:remove-bookmark-folder',
    IMPORT_BOOKMARKS: 'browser-pane:import-bookmarks',
    EXPORT_BOOKMARKS: 'browser-pane:export-bookmarks',
    LIST_HISTORY: 'browser-pane:list-history',
    REMOVE_HISTORY_ENTRY: 'browser-pane:remove-history-entry',
    CLEAR_HISTORY: 'browser-pane:clear-history',
    LIST_DOWNLOADS: 'browser-pane:list-downloads',
    CLEAR_DOWNLOADS: 'browser-pane:clear-downloads',
    OPEN_DOWNLOAD: 'browser-pane:open-download',
    SHOW_DOWNLOAD: 'browser-pane:show-download',
    PAUSE_DOWNLOAD: 'browser-pane:pause-download',
    RESUME_DOWNLOAD: 'browser-pane:resume-download',
    CANCEL_DOWNLOAD: 'browser-pane:cancel-download',
    RETRY_DOWNLOAD: 'browser-pane:retry-download',
    LIST_PERMISSIONS: 'browser-pane:list-permissions',
    CLEAR_PERMISSION: 'browser-pane:clear-permission',
    GET_SETTINGS: 'browser-pane:get-settings',
    UPDATE_SETTINGS: 'browser-pane:update-settings',
    GET_CACHE_SIZE: 'browser-pane:get-cache-size',
    CLEAR_DATA: 'browser-pane:clear-data',
    LIST_SITE_DATA: 'browser-pane:list-site-data',
    CLEAR_SITE_DATA: 'browser-pane:clear-site-data',
    CLEAR_ALL_SITE_DATA: 'browser-pane:clear-all-site-data',
    LIST_EXTENSIONS: 'browser-pane:list-extensions',
    INSTALL_EXTENSION: 'browser-pane:install-extension',
    INSTALL_EXTENSION_FROM_STORE: 'browser-pane:install-extension-from-store',
    REMOVE_EXTENSION: 'browser-pane:remove-extension',
    OPEN_EXTENSION_ACTION: 'browser-pane:open-extension-action',
    SHOW_TOOLBAR_MENU: 'browser-pane:show-toolbar-menu',
    SHOW_TAB_MENU: 'browser-pane:show-tab-menu',
    SET_EXTENSION_PREFERENCE: 'browser-pane:set-extension-preference',
  ...
  dynamic: {
    ...
    LIST: 'dynamic:list',
    MARK_READ: 'dynamic:markRead',
    CLEAR: 'dynamic:clear',
    RESOLVE: 'dynamic:resolve',
    GET_MUTE_RULES: 'dynamic:getMuteRules',
    SET_MUTE_RULES: 'dynamic:setMuteRules',
    RESPOND_PERMISSION: 'dynamic:respondPermission',
  },
  workflows: {
    LIST: 'workflows:list',
    SAVE: 'workflows:save',
  ...
  projects: {
    ...
    RESTORE_AUTOMATIONS: 'projects:restoreAutomations',
    LIST_PAUSED_AUTOMATIONS: 'projects:listPausedAutomations',
  ...
  library: {
    ...
    /** v0.20 Knowledge asset APIs; Library names remain compatibility aliases. */
    IMPORT_FILE: 'library:importFile',
    CREATE_MINDMAP: 'library:createMindMap',
    UPDATE_MINDMAP: 'library:updateMindMap',
    LIST_MINDMAPS: 'library:listMindMaps',
    GET_MINDMAP: 'library:getMindMap',
  },
} as const
